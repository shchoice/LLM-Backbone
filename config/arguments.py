...
class Arguments:
    ...
    def get_train_parse_arguments():
        ...
        parser.add_argument('--load_in_4bit', type=bool, default=True, help='Enable 4-bit quantization by replacing the Linear layers with FP4/NF4 layers from bitsandbytes.')
        ...
        parser.add_argument('--bnb_4bit_use_double_quant', type=bool, default=True, help='Used for nested quantization where the quantization constants from the first quantization are quantized again')
        ...
        parser.add_argument('--target_modules', type=str, default='query_key_value', help='The names of the modules to apply Lora to')
        ...
        parser.add_argument('--truncation', type=bool, default=True, help='Enable or disable truncation')
